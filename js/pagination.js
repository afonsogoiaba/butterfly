...
function popula(id, inicio, fim, sub){
	...
	let arrDescricao = ['This project was developed during the first semester of 2017 to obtain a grade on the subject of Presentation Language and Content Structuring 1. It was the final work of the subject with the goal of developing a portfolio of Web Designer.',
											...
											'Limbo Driver was a the proposed system for the second half of 2017 to get a grade in the Discipline of Presentation Language and Content Structuring 2. It works like Google Drive, but with a token access system, discarding user and password for simple tasks.',
											...
											'Portfolio of the stars was a project developed during the second semester of 2017 as final work of the discipline of Presentation Language and Content Structuring 2. The goal was to create a responsive web page applying the knowledge gained in subject.',
											'Portwiki was my undergraduate thesis from highschool. His idea was based on the largest programming learning platform: w3schools.com, but intended to function as a mini course management platform for the federal institute in question.',
											"The Sodelivery Express platform project was obtained as Freelancer. The client wanted a platform at the national level of delivery with motorcycles, trucks and freighters. However, as it was the first job as a freelancer and was very extensive, laborious and made by 4 people team, it wasn't possible to complete it.",
											"This portfolio begun to be developed on February 12, 2019 and was finished on April 6 , 2019. Its purpose, besides serving as a repository of projects and a way to demonstrate my work to my clients in a few clicks, it's also a timeline of evolutionary scale as a programmer. It is possible to see projects from when I started in the area, to the most current ones already completed or in under development."
											];
